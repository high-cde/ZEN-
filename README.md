...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/ZEN- |
| Visibilità | Pubblico |
| Tecnologia principale | Shell/Linux |
| Ruolo | Programing hub |
...
| Fase | Comando |
|---|---|
| Permessi script | `chmod +x *.sh` |
| Esecuzione controllata | `./script.sh` |
